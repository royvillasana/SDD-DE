 ...
 * (JavaScript build; see ComponentDocs.tsx for the fully-typed version + doc comment.)
 *
 * Storybook's Docs addon renders in React regardless of the project's framework, so this
 * single component is the docs page for React, Vue, Svelte, and Angular Storybooks alike.
 * Each component's stories file passes that component's metadata:
 *
...
const c = {
  ...
  h2: { fontSize: "1.25rem", fontWeight: 600, margin: "0 0 0.75rem", color: "#1a1a1a" },
...
export function ComponentDocs({ meta }) {
